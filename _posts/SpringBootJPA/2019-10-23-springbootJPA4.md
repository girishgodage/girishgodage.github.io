...
permalink: "/blog/spring-boot-with-mysql-and-oracle"
categories:
- SpringBootJPA
tags:
- learning
summary: Learn how to connect a Spring Boot application with relational databases
  like Oracle and MySQL. Learn how to setup a database schema for them and also what
  to configure in application configuration.
image: "/img/springbootJPA.png"
author: Girish Godage
layout: posts
prevurl: "/blog/spring-boot-and-h2-in-memory-database"
nexturl: "/blog/introduction-to-spring-data-with-spring-boot"
discussion_id: 2019-10-23-springbootJPA4
---

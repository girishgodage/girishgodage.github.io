...
<img src="{{site.url}}{{site.baseurl}}/img/database/3/MicrosoftSQLServer-300x76.png" align="left" style="height: 64px"/>SQL Server is a Relational Database Management System, which was developed by Microsoft in 2005 for the enterprise environment. 

...
It's own parameters for load balancers and scaling
Well defined server RAM and Memory consumption
Has its own dedicated database from where it can pull and show information. No other service can use this database
Its own API to communicate and respond to user search requests
Has a well defined boundary of what it can or can't do
